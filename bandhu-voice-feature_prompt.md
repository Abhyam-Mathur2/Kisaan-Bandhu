...
Agent name: Bandhu
Agent ID: agent_8401kmrag3adf5qv4gc619bwe4qq
...
function Agent() {
  ...
  const startConversation = async () => {
    ...
    await conversation.startSession({
      agentId: "agent_8401kmrag3adf5qv4gc619bwe4qq",
...
function ConversationScreen() {
  ...
  const start = async () => {
    await conversation.startSession({ agentId: "agent_8401kmrag3adf5qv4gc619bwe4qq" });
  };
...
function App() {
  return <elevenlabs-convai agent-id="agent_8401kmrag3adf5qv4gc619bwe4qq"></elevenlabs-convai>;
}

Or use the CDN directly in HTML:

<script src="https://elevenlabs.io/convai-widget/index.js" async></script>
<elevenlabs-convai agent-id="agent_8401kmrag3adf5qv4gc619bwe4qq"></elevenlabs-convai>
...
conversation = Conversation(
    client,
    agent_id="agent_8401kmrag3adf5qv4gc619bwe4qq",
    requires_auth=False,
...
Endpoint: wss://api.elevenlabs.io/v1/convai/conversation?agent_id=agent_8401kmrag3adf5qv4gc619bwe4qq

const ws = new WebSocket(
  "wss://api.elevenlabs.io/v1/convai/conversation?agent_id=agent_8401kmrag3adf5qv4gc619bwe4qq"
);
...
const response = await fetch(
  `https://api.elevenlabs.io/v1/convai/conversation/token?agent_id=agent_8401kmrag3adf5qv4gc619bwe4qq`,
